...
uint256 hashGenesisBlock("0xbdb124a0cc964559925609f4470097e5303fbd2fe56a5ca754a37fa42d8aaa04");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(537261531); // FweeCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "FweeCoin Signed Message:\n";
...
{
    // FweeCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
{
    int64 nSubsidy = 5000000000000;

    // Subsidy is cut in half every 840000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 500); // FweeCoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 60; // FweeCoin: 3.5 days
static const int64 nTargetSpacing = 60; // FweeCoin: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // FweeCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // FweeCoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // FweeCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x0bc2bc762168f4adbc9730757efa5b2b52ccb2669ec24ef6c31ff90b11dab726");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "I heard you like free stuff";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("e1b022be82afd1029984feb359e9122e4b960664df148550eb1624eb2d0fed738471ca1b38dc2e0dc3020041153111d176527021ac15806d61359fc27a8e6b7ef8") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1464664053;
        block.nBits    = 537261531;
        block.nNonce   = 1840589358;

        if (fTestNet)
        {
            block.nTime    = 1464664053;
            block.nNonce   = 1607437790;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x637ba8fcc8f09112c54d56ba54ab39ec8c81d97d2a5c71b27e9064d64e55e637"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // FweeCoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("FweeCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("FweeCoinMiner : ProcessBlock, block not accepted");
    }
